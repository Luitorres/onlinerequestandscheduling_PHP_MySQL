...
<body>
    ...
    <div class="content">
        <div class="approve" id="approve_section">
            <h2 class="namerequest">Approve Request Certificate</h2>
            <hr class="lining">
            <div class="tableHead">
                ...
                <section class="scheduleTable">
                    <table>
                        ...
                        <?php while ($clearanceRow = $clearanceResult->fetch_assoc()) {
                            if ($clearanceRow['status'] !== 'APPROVED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
                        ...
                        <?php while ($goodmoralRow = $goodmoralResult->fetch_assoc()) {
                            if ($goodmoralRow['status'] !== 'APPROVED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
                        ...
                        <?php while ($barangayidRow = $barangayidResult->fetch_assoc()) {
                            if ($barangayidRow['status'] !== 'APPROVED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
                        ...
                        <?php while ($indigencyRow = $indigencyResult->fetch_assoc()) {
                            if ($indigencyRow['status'] !== 'APPROVED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
                        ...
                        <?php while ($residencyRow = $residencyResult->fetch_assoc()) {
                            if ($residencyRow['status'] !== 'APPROVED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
