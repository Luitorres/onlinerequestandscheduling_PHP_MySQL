...
if(isset($_POST['Submit'])){
    ...
    $insert_request = mysqli_query($conn, "INSERT INTO `request_goodmoral`(`account`, `first_name`, `last_name`, `middle_name`, `suffix_name`, `birthday`, `place_of_birth`, `civil_status`, `sex`, `nationality`, `pwd`, `occupation`, `contact`, `email`, `address`, `street`, `barangay`, `city`, `sched`, `time`, `slot`, `message`, `status`) 
...
$sql = "SELECT * FROM request_goodmoral ORDER BY id DESC LIMIT 1";
...
<head>
    ...
    <title>Mapulang Lupa | Barangay Good Moral</title>
