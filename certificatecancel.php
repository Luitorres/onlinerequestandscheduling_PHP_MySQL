...
<body>
    ...
    <div class="content">
        <div class="cancel" id="cancel_section">
            <h2 class="namerequest">Cancel Request Certificate</h2>
            <hr class="lining">
            <div class="tableHead">
                ...
                <section class="scheduleTable">
                    <table>
                        ...
                        <?php while ($clearanceRow = $clearanceResult->fetch_assoc()) {
                            if ($clearanceRow['status'] !== 'CANCELED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
                        ...
                        <?php while ($goodmoralRow = $goodmoralResult->fetch_assoc()) {
                            if ($goodmoralRow['status'] !== 'CANCELED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
                        ...
                        <?php while ($barangayidRow = $barangayidResult->fetch_assoc()) {
                            if ($barangayidRow['status'] !== 'CANCELED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
                        ...
                        <?php while ($indigencyRow = $indigencyResult->fetch_assoc()) {
                            if ($indigencyRow['status'] !== 'CANCELED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
                        ...
                        <?php while ($residencyRow = $residencyResult->fetch_assoc()) {
                            if ($residencyRow['status'] !== 'CANCELED') {
                            continue; // Skip this iteration and move to the next record
                        } ?>
                        <tr class="headRow"></tr>
                        <tr class="bodyRow">
